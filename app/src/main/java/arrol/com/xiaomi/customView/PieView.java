 ...
 */
public class PieView extends View implements Runnable{
    ...
    // 颜色值
    private final String[] DEFAULT_ITEMS_COLORS = {"#FFFF01",
    ...
    // 监听器集合
    private PieViewItemListener itemSelectedListener;

    public PieView(Context context, String[] itemColors,
    ...
    public PieView(Context context, AttributeSet attrs) {
        ...
        radius = ScreenUtil.dip2px(getContext(),
                a.getFloat(R.styleable.PieView_radius, 100));
        strokeWidth = ScreenUtil.dip2px(getContext(),
                a.getFloat(R.styleable.PieView_strokeWidth, 2));
        moveSpeed = a.getFloat(R.styleable.PieView_moveSpeed, 5);
        if (moveSpeed < 1F) {
            moveSpeed = 1F;
        }
        if (moveSpeed > 5.0F) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 画中心的小圆
        paint.setStyle(Paint.Style.FILL);
        paint.setColor(Color.parseColor("#42c0f5"));
    ...
    protected void onDetachedFromWindow() {
        ...
        pieHandler.removeCallbacks(this);
    }
    ...
    public void run() {
        if (isClockWise) {
            ...
            invalidate();
            pieHandler.postDelayed(this, 10L);
    ...
    public PieViewItemListener getItemSelectedListener() {
        return itemSelectedListener;
    }

    public void setItemSelectedListener(
            PieViewItemListener itemSelectedListener) {
